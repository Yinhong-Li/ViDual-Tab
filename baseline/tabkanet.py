...
class Activation(nn.Module):
    def __init__(self, activation: str) -> None:
        ...
        elif activation.lower() in {'tanh', 'sigmoid', 'hardshrink', 'hardsigmoid', 'tanhshrink', 'softshrink',
                                    'softsign', 'softplus'}:
...
class TabKANet(nn.Module):
    def __init__(self,
                 output_dim: int, num_continuous_features: int,
        ...
        self.classifier = MLP(embedding_dim * num_continuous_features, output_dim, mlp_hidden_dims,
                              activation, ffn_dropout_rate)

    def forward(self, continuous_x: ty.Optional[Tensor], categorical_x: ty.Optional[Tensor]):
